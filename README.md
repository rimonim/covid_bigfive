...
theme(text=element_text(family="notosans"),
 legend.position="bottom") +
  labs(title="Does Extraversion Predict\nGrowth in COVID-19 Cases?",
...
``` r
 ...
 ggplot(unified_data ,aes(x= EST, y= growth, 
   ...
   theme(text=element_text(family="notosans"),
         legend.position="bottom") +
   labs(title="Does Emotional Stability Predict\nGrowth in COVID-19 Cases?",
...
``` r
 ...
 ggplot(unified_data ,aes(x= AGR, y= growth, 
   ...
   theme(text=element_text(family="notosans"),
         legend.position="bottom") +
   labs(title="Does Agreeableness Predict\nGrowth in COVID-19 Cases?",
...
``` r
 ...
 ggplot(unified_data ,aes(x= CSN, y= growth, 
   ...
   theme(text=element_text(family="notosans"),
         legend.position="bottom") +
   labs(title="Does Conscientiousness Predict\nGrowth in COVID-19 Cases?",
...
``` r
 ...
 ggplot(unified_data ,aes(x= OPN, y= growth, 
   ...
   theme(text=element_text(family="notosans"),
         legend.position="bottom") +
   labs(title="Does Openness Predict\nGrowth in COVID-19 Cases?",
